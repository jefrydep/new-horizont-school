    ...
    <header className="bg-primary h-16">
      <div className="flex justify-between m-auto container px-4 py-2">
        ...
        {isOpen && (
          <>
            <nav
              className="outline-none absolute flex flex-col top-0 bottom-0 right-0 left-6 bg-black opacity-90 z-30 list-none transition-all ease-in-out duration-500 transform translate-x-0"
            >
