...
const ImageSlider = () => {
  ...
  return (
    <div className="relative w-full   mx-auto overflow-hidden">
      ...
      <button
        onClick={prevSlide}
        className="  top-1/2 left-4 transform -translate-y-1/2 text-white bg-black bg-opacity-50 p-2 rounded-full"
      >
        &#8592;
      </button>
      <button
        onClick={nextSlide}
        className="  top-1/2 right-4 transform -translate-y-1/2 text-white bg-black bg-opacity-50 p-2 rounded-full"
      >
        &#8594;
      </button>
