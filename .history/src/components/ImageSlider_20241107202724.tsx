...
const ImageSlider = () => {
  ...
  return (
    <div className="relative w-full    mx-auto overflow-hidden">
      {/* Imagen activa */}
      <div className="w-full mt-1    h-[56vh]">
        <img
          src={images[currentIndex]}
          alt={`Slide ${currentIndex + 1}`}
          className="w-full h-full object-cover bg-fixed transition-transform duration-500 ease-in-out"
        />
      </div>

      {/* Contenido centrado con efecto de escritura */}
      <div className="absolute inset-0 flex justify-center items-center text-white text-center bg-sky-200 bg-opacity-40">
        <div className="">
          <h2 className="text-6xl mb-9">Admisión</h2>
          <h2 className="text-5xl font-bold mb-4 overflow-hidden sm:whitespace-nowrap ">
