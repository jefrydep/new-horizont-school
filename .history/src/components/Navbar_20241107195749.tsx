...
export default function Navbar() {
  ...
  return (
    <header className="bg-sky-800 shadow-md h-16">
      <div className="flex justify-between items-center  bg-yellow-300 m-auto container px-4 py-2">
        <div className="text-white">New Horizont</div>
        <nav className="outline-none hidden bg-red-500  sm:flex items-center  list-none">
