...
export default function Navbar() {
  ...
  return (
    <header className="bg-primary h-16">
      <div className="flex justify-between  container px-4 py-2">
  ...
  } absolute top-0 bottom-0 right-0 left-0 bg-black opacity-95 z-30 list-none transition-all ease-in-out duration-1000`}
>
  {isOpen && (
    <>
